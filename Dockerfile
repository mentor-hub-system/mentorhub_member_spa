...
ARG GITHUB_TOKEN
RUN echo "@mentor-hub-system:registry=https://npm.pkg.github.com" > .npmrc && \
...
LABEL org.opencontainers.image.source="https://github.com/mentor-hub-system/mentorhub_member_spa"

ENV API_HOST=mentorhub_member_api
ENV API_PORT=8393
